...
<p class="text-large mt-30"><span class="font-purple">Création d'une interface</span> qui permet de se rediriger sur les différents sites web utilisés par l'entreprise.</p>
...
<img class="presentation-img mt-60" src="<?= HTML_ROOT ?>/assets/img/project/stage_ezhub.webp">
